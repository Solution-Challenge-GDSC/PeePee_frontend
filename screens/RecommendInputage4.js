  ...
  return (
    <View style={styles.recommendInputage}>
      ...
      <View style={styles.groupParent}>
        ...
        <Text style={[styles.recognitionDevelopment, styles.text1Clr]}>
      ...
      <Pressable style={styles.categoryParent}>
...
export default RecommendInputage4;
