  ...
  return (
    <View style={styles.recommendInputage}>
      ...
      <View style={styles.groupParent}>
        ...
        <Text style={[styles.emotionDevelopment, styles.text1Clr]}>
          Emotion Development
        </Text>
      ...
      <View style={styles.categoryParent}>
        ...
        <View style={styles.groupContainer}>
          ...
          >
            ...
            />
            <Text style={[styles.recognition, styles.motionTypo]}>
              Recognition
            </Text>
          </Pressable>
          <Pressable
...
export default RecommendInputage2;
